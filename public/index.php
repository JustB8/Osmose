  ...
  <body>
      ...
      <main class="body">
        ...
        <p class="p">
          ...
          himenaeos.<br />Lorem ipsum dolor sit amet consectetur adipiscing elit. Quisque faucibus ex sapien vitae
        ...
        <button id="btn_ldr_comp" type="button">
          <span class="button-4">Consulter le classement</span>
        </button>
