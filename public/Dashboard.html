    ...
    <div class="ecran-de-desktop">
      ...
      <main class="component">
        <section class="points-section">
          ...
          <div class="rectangle" role="img" aria-label="Cadre des points de l'entreprise"></div>
        ...
        <section class="points-section-user">
          ...
          <div class="rectangle-2" role="img" aria-label="Cadre des points de l'utilisateur"></div>
